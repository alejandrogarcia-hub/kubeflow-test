...
# Kubeflow Pipelines Upgrade Script to v2.3.0
# This script upgrades an existing KFP installation to version 2.3.0
...
echo -e "${GREEN}================================================${NC}"
echo -e "${GREEN}Kubeflow Pipelines Upgrade to v2.3.0${NC}"
echo -e "${GREEN}================================================${NC}"
...
# Step 4: Apply KFP v2.3.0
echo -e "\n${YELLOW}Step 4: Installing Kubeflow Pipelines v2.3.0...${NC}"
